...
const translations: { [key in Language]: { [key: string]: string } } = {
  en: {
    ...
    sessionClearedDesc: "The data file has been reset.",
  ...
  ar: {
    ...
    sessionClearedDesc: "تمت إعادة تعيين ملف البيانات.",
    downloadDashboard: "تحميل لوحة التحكم",
    generatingPdf: "جاري إنشاء PDF...",
    pdfGenError: "تعذر إنشاء PDF. يرجى المحاولة مرة أخرى.",
    detailedAnalysisTitle: "التحليل التفصيلي",
  },
};
