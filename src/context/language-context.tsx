...
const translations: { [key in Language]: { [key: string]: string } } = {
  en: {
    ...
    analysisFailedDesc: "Sasha could not analyze the document. Please ensure it's a valid financial statement and try again.",
    ...
    // Sasha Vision
    sashaVisionTitle: "Sasha Vision",
    sashaVisionDesc: "A creative space to generate and enhance images using AI.",
    ...
    upscalingMessage: "Sasha is enhancing your image...",
    ...
    learnSpreadsheetDesc: "This is not just a spreadsheet; it's an intelligent workspace where you command an expert AI financial analyst with natural language. Say 'Create a 5-year DCF model for a SaaS company,' 'Generate a Gantt chart for the Q4 product launch,' or 'Analyze these sales figures and highlight all regions that underperformed by 15%.' Sasha functions as a state-of-the-art AI agent, understanding your intent, structuring the data, applying complex formulas, and executing multi-step operations instantly. With a rich library of professional templates and a full suite of formatting tools, it transforms your productivity, rivaling traditional desktop applications.",
  ...
  ar: {
    ...
    analysisFailedDesc: "لم تتمكن ساشا من تحليل المستند. يرجى التأكد من أنه بيان مالي صالح والمحاولة مرة أخرى.",
    ...
    // Sasha Vision
    sashaVisionTitle: "رؤية ساشا",
    sashaVisionDesc: "مساحة إبداعية لإنشاء الصور وتحسينها باستخدام الذكاء الاصطناعي.",
    ...
    upscalingMessage: "ساشا تقوم بتحسين صورتك...",
    ...
    learnSpreadsheetDesc: "هذا ليس مجرد جدول بيانات؛ إنها مساحة عمل ذكية حيث تأمر محللًا ماليًا خبيرًا بالذكاء الاصطناعي بلغة طبيعية. قل 'أنشئ نموذج DCF لمدة 5 سنوات لشركة SaaS'، 'أنشئ مخطط جانت لإطلاق منتج الربع الرابع'، أو 'حلل أرقام المبيعات هذه وقم بتمييز جميع المناطق التي كان أداؤها أقل بنسبة 15%'. تعمل ساشا كوكيل ذكاء اصطناعي على أحدث طراز، حيث تفهم نيتك، وتنظم البيانات، وتطبق الصيغ المعقدة، وتنفذ عمليات متعددة الخطوات على الفور. مع مكتبة غنية من القوالب الاحترافية ومجموعة كاملة من أدوات التنسيق، فإنها تغير إنتاجيتك، وتنافس تطبيقات سطح المكتب التقليدية.",
