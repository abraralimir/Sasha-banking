...
const translations: { [key in Language]: { [key: string]: string } } = {
  en: {
    ...
    daUploadPromptDesc: "Upload your data file and Sasha will instantly generate an interactive dashboard. Use the chat to ask for more specific visualizations.",
    daUploadButton: "Upload Data File",
    daChatPlaceholder: "e.g., Show me total sales by region as a bar chart",
    daFileProcessingTitle: "Analyzing Data",
    daFileProcessingDesc: "Sasha is building your dashboard for {{fileName}}...",
    sashaDAFileLoaded: "I've successfully analyzed {{fileName}}. Here is your initial dashboard. What else would you like to explore?",
    ...
    daGeneratingDashboardDesc: "Sasha is analyzing your data and designing the optimal layout.",
  ...
  ar: {
    ...
    daUploadPromptDesc: "قم بتحميل ملف البيانات الخاص بك وستقوم ساشا على الفور بإنشاء لوحة معلومات تفاعلية. استخدم الدردشة لطلب المزيد من التصورات المحددة.",
    daUploadButton: "تحميل ملف البيانات",
    daChatPlaceholder: "مثال: أرني إجمالي المبيعات حسب المنطقة في مخطط شريطي",
    daFileProcessingTitle: "تحليل البيانات",
    daFileProcessingDesc: "ساشا تقوم ببناء لوحة التحكم الخاصة بك لـ {{fileName}}...",
    sashaDAFileLoaded: "لقد حللت {{fileName}} بنجاح. ها هي لوحة التحكم الأولية الخاصة بك. ماذا تود أن تستكشف أيضاً؟",
    ...
    daGeneratingDashboardTitle: "جاري إنشاء لوحة التحكم الخاصة بك...",
    daGeneratingDashboardDesc: "تقوم ساشا بتحليل بياناتك وتصميم التخطيط الأمثل.",
