...
const translations: { [key in Language]: { [key: string]: string } } = {
  en: {
    ...
    initialMessage: "Hello! I'm Sasha, your expert financial advisor with a specialization in Omani credit rules. How can I assist you with your banking needs, loan analysis, or financial statements today?",
    placeholder: "Message Sasha...",
    uploadCsvTooltip: "Upload Loan CSV",
    uploadPdfTooltip: "Upload Financial PDF",
    generateImageTooltip: "Generate Image",
    ...
    imageDialogDesc: "Describe the image you want to create. Let Sasha work her magic.",
    pollinationsDisclaimer: "Images are not generated by Sasha right now, it's using Pollinations.ai. Sasha's image generation is coming soon.",
    promptLabel: "Prompt",
    promptPlaceholder: "e.g., A cute cat wearing a wizard hat",
    generateButton: "Generate",
    generatingMessage: "Generating your masterpiece...",
    generateAnotherButton: "Generate Another",
    downloadButton: "Download",
    addToChatButton: "Add to Chat",
    imageGenFailedTitle: 'Image Generation Failed',
    imageGenFailedDesc: "Sasha couldn't conjure an image for that prompt. Please try a different one.",
    english: 'English',
    arabic: 'Arabic'
  },
  ar: {
    pageTitle: 'ساشا المصرفية',
    initialMessage: "مرحباً! أنا ساشا، مستشارك المالي الخبير والمتخصص في قواعد الائتمان العمانية. كيف يمكنني مساعدتك في احتياجاتك المصرفية، تحليل القروض، أو البيانات المالية اليوم؟",
    placeholder: "راسل ساشا...",
    uploadCsvTooltip: "تحميل ملف CSV للقروض",
    uploadPdfTooltip: "تحميل ملف PDF مالي",
    generateImageTooltip: "إنشاء صورة",
    ...
    imageDialogTitle: "إنشاء الصور بالذكاء الاصطناعي",
    imageDialogDesc: "صف الصورة التي تريد إنشاءها. دع ساشا تقوم بسحرها.",
    pollinationsDisclaimer: "الصور لا يتم إنشاؤها بواسطة ساشا حاليًا، بل تستخدم Pollinations.ai. ميزة إنشاء الصور الخاصة بساشا ستتوفر قريبًا.",
    promptLabel: "موجه",
    promptPlaceholder: "مثال: قطة لطيفة ترتدي قبعة ساحر",
    generateButton: "إنشاء",
    generatingMessage: "جاري إنشاء تحفتك الفنية...",
    generateAnotherButton: "إنشاء صورة أخرى",
    downloadButton: "تحميل",
    addToChatButton: "إضافة إلى الدردشة",
    imageGenFailedTitle: 'فشل إنشاء الصورة',
    imageGenFailedDesc: "لم تتمكن ساشا من استحضار صورة لهذا الموجه. يرجى تجربة موجه آخر.",
    english: 'الإنجليزية',
    arabic: 'العربية'
  },
};
