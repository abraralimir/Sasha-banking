...
const translations: { [key in Language]: { [key: string]: string } } = {
  en: {
    ...
    // Data Analytics Page
    daUploadPromptTitle: "Client-Side Data Analysis",
    daUploadPromptDesc: "Upload your data file (XLSX, CSV, PDF) to have Sasha analyze it directly in your browser.",
    daUploadButton: "Upload Data File",
    daGeneratingDashboardTitle: "Analyzing...",
    daGeneratingDashboardDesc: "Please wait while the AI model works its magic.",
    analysisResultTitle: "Analysis Result",
    daResetButton: "Analyze Another File",
    daSummaryTitle: "AI Summary",
    daChartTitle: "Data Visualization",
    daParsingFile: "Parsing your file...",
    daSummarizingPdf: "Summarizing PDF content...",
    daAnalyzingData: "Analyzing data structure...",
    daGeneratingSummary: "Generating AI summary...",
    daChartLabel: "Distribution of {{column}}",
    daAnalysisFailedDesc: "The client-side analysis failed. The file might be corrupted or in an unsupported format.",
  },
  ar: {
    ...
    // Data Analytics Page
    daUploadPromptTitle: "تحليل البيانات من جانب العميل",
    daUploadPromptDesc: "قم بتحميل ملف البيانات الخاص بك (XLSX, CSV, PDF) لتقوم ساشا بتحليله مباشرة في متصفحك.",
    daUploadButton: "تحميل ملف البيانات",
    daGeneratingDashboardTitle: "جاري التحليل...",
    daGeneratingDashboardDesc: "يرجى الانتظار بينما يعمل نموذج الذكاء الاصطناعي.",
    analysisResultTitle: "نتيجة التحليل",
    daResetButton: "تحليل ملف آخر",
    daSummaryTitle: "ملخص الذكاء الاصطناعي",
    daChartTitle: "تصور البيانات",
    daParsingFile: "جاري تحليل ملفك...",
    daSummarizingPdf: "جاري تلخيص محتوى PDF...",
    daAnalyzingData: "جاري تحليل بنية البيانات...",
    daGeneratingSummary: "جاري إنشاء ملخص الذكاء الاصطناعي...",
    daChartLabel: "توزيع {{column}}",
    daAnalysisFailedDesc: "فشل التحليل من جانب العميل. قد يكون الملف تالفًا أو بتنسيق غير مدعوم.",
  },
};
