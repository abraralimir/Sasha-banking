...
const generateDashboardPrompt = ai.definePrompt({
  ...
  prompt: `You are a world-class AI data analyst named Sasha. Your task is to analyze the provided file and generate a comprehensive, structured dashboard report. Your entire response MUST be in the specified language: {{{language}}}.
